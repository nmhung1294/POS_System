...
# Tests: CachePerformanceTest
# Total: 5 tests
# ================================================================

Write-Host ""
Write-Host "========================================"
Write-Host "PHASE 2: CACHE PERFORMANCE TESTS"
Write-Host "========================================"
Write-Host ""
...
Write-Host "Compiling Phase 2 Runner..." -ForegroundColor Cyan
$phase2Runner = Join-Path $SRC_DIR "test\performance\Phase2Runner.java"
javac -cp $classpath -d $BUILD_DIR $phase2Runner
...
Write-Host "Running Phase 2 Tests..." -ForegroundColor Green
Write-Host ""
java -cp $classpath test.performance.Phase2Runner
